...
public class Application {
	...
	private void createAdminUserIfNotExist(){
		...
		Account account2 = qrCodeStorageService.findAccountByUsername("duc");
		if(account2 == null){
			account2 = new Account();
			account2.setUsername("duc");
			account2.setPassword(passwordEncoder.encode("123"));
			account2.setStatus(1);
			account2.setKind(1);
			account2.setFullName("Duc");
			account2.setIsSuperAdmin(true);
			qrCodeStorageService.save(account2);
		}
